...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/junctionchart/junctionnewovertime.js"></script>
  </head>
    ...
    <div id="body" region="center"  hide="true"  split="true">
	  	<div id="junctionOvertime_btn">
			<div style="margin-bottom: 5px;margin-left:20px;">
				<a href="javascript:goback()" class="easyui-linkbutton" iconCls="icon-back" id="pageUp">返回</a>
