...
<html>
  ...
  <body class="easyui-layout">
    ...
    <div id="body" region="center"  hide="true"  split="true" title="事业部焊接工艺超标统计" style="background: witch; height: 335px;">
		...
		统计时间段内的超规范焊接趋势；</div>
		<div id="caustOverproofChart" style="height:50%;width:65%;margin-right: 21%;margin-left: 21%;margin-bottom:10px;"></div>
