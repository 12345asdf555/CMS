...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/android/livedata.js"></script>

  </head>
  
<body class="easyui-layout">
	<div id="bodydiv" region="center"  hide="true"  split="true" style="padding:10px;background: #fff; width:600px;height: 335px;">
		<!-- 实时焊机 -->
