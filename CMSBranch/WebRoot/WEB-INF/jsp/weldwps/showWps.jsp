...
<body id="wpsbody">
    <div style="margin-top:10px;margin-left:20px;">
       	<a href="wps/goWps" class="easyui-linkbutton" iconCls="icon-redo">返回</a>
       	<a href="javascript:printWps();" style="margin-left:20px;" class="easyui-linkbutton" iconCls="icon-print">打印</a>
   	</div>
   	<!--startprint-->
	<div>
		<p align="center">
