...
<html>
  ...
  <body class="easyui-layout">
	...
	<div id="bloc2" >
    	<ul>
    		<li onclick="changeColor(this)"><a href="javascript:welderHeight()"><div><img src="resources/images/s-14.png" />&nbsp;&nbsp;焊工最高排行</div></a></li>
    		<li onclick="changeColor(this)"><a href="javascript:welderLess()"><div><img src="resources/images/s-13.png" />&nbsp;&nbsp;焊工最低排行</div></a></li>
    	</ul>
    </div>
	<!-- 公司 -->
    <div id="company1" >
