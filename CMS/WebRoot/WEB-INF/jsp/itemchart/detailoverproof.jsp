...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/itemchart/detailoverproof.js"></script>
  </head>
  ...
  <body class="easyui-layout">
    <div id="bodydiv" region="center"  hide="true"  split="true">
		...
		<div><h2>${str }</h2></div>
	    <table id="DetailOverproofTable" style="table-layout: fixed; width:100%;"></table>
	</div>
  </body>
</html>
