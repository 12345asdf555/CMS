...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/junctionchart/detailnoloads.js"></script>
  </head>
  
  <body class="easyui-layout">
    <div id="body" region="center"  hide="true"  split="true" title="焊机空载率明细" style="background: witch; height: 335px;">
		...
		<div><h2>${str }</h2></div>
	    <table id="detailNoLoadsTable" style="table-layout: fixed; width:100%;"></table>
	</div>
  </body>
</html>
