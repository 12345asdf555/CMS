...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/caustchart/caustoverproof.js"></script>
  </head>
  ...
  <body class="easyui-layout">
    ...
    <div id="body" region="center"  hide="true"  split="true" title="焊接工艺超标统计" style="background: witch; height: 335px;">
	  	<div id="caustOverProof_btn">
		...
		<div id="maxexplain">
			<div id="explain">
				<span>焊接工艺超标统计</span><hr>
				<ul>
					<li>展现某一时间段内，各部门的超规范焊接时长及趋势</li>
				</ul>
			</div>
		</div>
		<div id="caustOverproofChart" style="height:50%;width:70%;margin-right: 21%;margin-left: 21%;margin-bottom:10px;"></div>
		
	    <table id="caustOverproofTable" style="table-layout: fixed; width:100%;"></table>
