...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/blocchart/blocloads.js"></script>
  </head>
  ...
  <body class="easyui-layout">
    ...
    <div id="bodydiv" region="center"  hide="true"  split="true" title="设备负荷率" style="background: witch; height: 335px;">
		...
		<div class="divParent">
			<div id="blocLoadsChart" style="height:100%;width:100%;"></div>
		</div>
