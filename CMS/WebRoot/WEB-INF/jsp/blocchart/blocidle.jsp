...
<html>
  ...
  <body class="easyui-layout">
    ...
    <div id="body" region="center"  hide="true"  split="true" title="设备闲置率" style="background: witch; height: 335px;">
	  	<div id="blocIdle_btn">
		...
		<div id="blocIdleChart" style="height:50%;width:70%;margin-right: 21%;margin-left: 21%;margin-bottom:10px;"></div>
