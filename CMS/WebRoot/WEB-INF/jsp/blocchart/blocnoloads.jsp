...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/blocchart/blocnoloads.js"></script>
  </head>
  ...
  <body class="easyui-layout">
    ...
    <div id="bodydiv" region="center"  hide="true"  split="true" title="设备平均空载率" style="background: witch; height: 335px;">
	  	<div id="blocNoLoads_btn">
		...
		<div id="blocNoLoadsChart" style="height:50%;width:70%;margin-right: 21%;margin-left: 21%;margin-bottom:10px;"></div>
