		...
		<form id="fm" class="easyui-form" method="post" data-options="novalidate:true">
			<table id="tb" align="center" style='border-collapse:collapse;border:none;'>
	 			<thead> 
					<tr>
						...
						<td width=220 colspan=11 class="border_bottom">
							<span>编号：</span>
							</span class="fontstyle"><input class="easyui-textbox" id="fwpsnum" name="fwpsnum" data-options="validType:'wpsValidate',required:true"></span>
						</td>
						<td width=220 colspan=6 class="border_bottom">
							<span>版本：</span>
							</span class="fontstyle"><input class="easyui-numberbox" id="fversions" name="fversions" data-options="required:true"></span>
						</td>
					</tr>
				</thead>
				<tr>
					...
					<td width=500 colspan=20 class="border_right">
						<span class="fontstyle">
							<textarea rows="2" cols="70" id="fproject_code" name="fproject_code" class="easyui-validatebox" data-options="required:true"></textarea>
						</span>
					</td>
				</tr>
				<tr>
					...
					<td width=284 colspan=12 class="border_right">
						<span class="fontstyle"><input class="easyui-textbox" id="freport_number" name="freport_number" data-options="required:true"></span>
					</td>
				...
				<tr>
					...
					<td width=284 colspan=12 class="border_right">
						<span class="fontstyle"><input class="easyui-textbox" id="fevaluation_standard" name="fevaluation_standard" data-options="required:true"></span>
					</td>
					<td width=104 colspan=5 class="border_right">
						<span>稳压系统</span>
					</td>
				...
				<tr style='height:16.15pt'>
					...
					<td width=284 colspan=12 class="border_right">
						<span class="fontstyle"><input class="easyui-textbox" id="fvalidity" name="fvalidity" data-options="required:true"></span>
					</td>
					<td width=104 colspan=5 class="border_right">
						<span>自动跟踪系统</span>
					</td>
					<td width=113 colspan=3 class="border_right">
						<span class="fontstyle">
							<select class="easyui-combobox" id="fautomatic" name="fautomatic" style="width:100px;" data-options="required:true,editable:false">
								<option value="有">有</option>
								<option value="无">无</option>
							</select>	
						</span>
				...
				<tr style='height:16.55pt'>
					...
					<td width=358 colspan=14 valign=top style="border-right:1px solid #000;">
						<span>焊接接头简图</span><br/>
						<span class="fontstyle">(<input class="easyui-textbox" id="fimages_desc" name="fimages_desc">)</span>
					</td>
				</tr>
...
<!-- 				          <input type="button" value="上传" onclick="importWeldingMachine()" class="upButton"/> -->
				...
				<tr>
					...
					<td width=151 colspan=7 class="border_right">
						<span class="fontstyle">
							HWS:<input class="easyui-numberbox" min="0.001" precision="3" id="fthickness1" name="fthickness1" data-options="iconCls:'icon-search',iconWidth:50,required:true">mm
							HD:<input class="easyui-numberbox" min="0.001" precision="3" id="fthickness2" name="fthickness2" data-options="iconCls:'icon-search',iconWidth:50,required:true">mm
						</span>
					</td>
				</tr>
				<tr>
				...
				<tr style='height:26.25pt' class="border_left">
					...
					<td width=208 colspan=10 class="border_right">
						<span class="fontstyle">
							<select class="easyui-combobox" id="felse2" name="felse2" data-options="required:true,editable:false">
								<option value="N/A">N/A</option>
							</select>
						</span>
					</td>
					...
					<td width=264 colspan=12 class="border_right">
						<span class="fontstyle">
							<select class="easyui-combobox" id="ftail" name="ftail" data-options="required:true,editable:false">
								<option value="N/A">N/A</option>
							</select>
						</span>
					</td>
				...
				<tr>
					...
					<td width=208 colspan=10 class="border_right">
						<span class="fontstyle">
							<select class="easyui-combobox" id="fPreheat_way" name="fPreheat_way" data-options="required:true,editable:false">
								<option value="N/A">N/A</option>
								<option value="4h">4h</option>
							</select>
						</span>
				...
				<tr>
					...
					<td width=233 colspan=9 class="border_right">
						<span class="fontstyle">
							<select class="easyui-combobox" id="ftransient_mode" name="ftransient_mode" data-options="required:true,editable:false">
								<option value="N/A">N/A</option>
							</select>
						</span>
					</td>
				...
				<tr>
					...
					<td width=434 colspan=18 class="border_right">
						<span class="fontstyle">
							<select class="easyui-combobox" id="fmethod1" name="fmethod1" data-options="required:true,editable:false">
				...
				<tr>
					...
					<td width=434 colspan=18 class="border_right">
						<span class="fontstyle">
							<select class="easyui-combobox" id="fmethod2" name="fmethod2" data-options="required:true,editable:false">
