...
<body class="easyui-layout">
	<div id="bodys" region="center" hide="true" split="true" title="实时界面" style="background: #fff; height: 335px;">
		<div style="width:20%;height:150px;float:left;">
			点击示意图返回<br /><a href="android/gomachineAllTd"><img id="mrjpg" src="resources/images/welder_04.png" width="35%" height="70%" style="margin-left:20px"></a>
		</div>
		...
		<div style="width:98%;height:70%;border:2px solid #eee">
			实时曲线
