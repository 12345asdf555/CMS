...
<html>
  <head>
	...
	<script type="text/javascript" src="resources/js/android/machineBackUp.js"></script>
...
<body class="easyui-layout">
	<div id="bodydiv" region="center"  hide="true"  split="true" style="background: #fff; width:600px;height: 335px;">
		<!-- 饼图 -->
