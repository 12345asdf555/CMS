  ...
  <jsp:include  page="../insframeworktree.jsp"/>
  	<div id="body" region="center"  hide="true"  split="true" title="采集模块管理" style="background: witch; height: 325px;">
		...
		<div id="dlg" class="easyui-dialog" style="width: 400px; height: 500px; padding:10px 20px" closed="true" buttons="#dlg-buttons">
			<form id="fm" class="easyui-form" method="post" data-options="novalidate:true"><br/>
				...
				<div class="fitem">
					...
					<input class="easyui-textbox" name="itemname" id="itemname"  data-options="required:true" readonly="readonly"/>
				</div>
				<div class="fitem">
		...
		<div id="remove-buttons">
			<a href="javascript:removeGather1();" class="easyui-linkbutton" iconCls="icon-ok">删除</a>
