...
<html>
  ...
  <body class="easyui-layout">
	...
	<div id="bloc1" >
    	<ul>
    		<li onclick="changeColor(this)"><a href="javascript:openCompanyTd()"><div><img src="resources/images/s-8.png" />&nbsp;&nbsp;实时监测</div></a></li>
    		<li onclick="changeColor(this)"><a href="javascript:openUseratio()"><div><img src="resources/images/s-7.png" />&nbsp;&nbsp;设备利用率</div></a></li>
    		<li onclick="changeColor(this)"><a href="javascript:welding()"><div><img src="resources/images/c-7.png" />&nbsp;&nbsp;焊机</div></a></li>
    		<li onclick="changeColor(this)"><a href="javascript:welderHeight()"><div><img src="resources/images/c-2.png" />&nbsp;&nbsp;焊工最高排行</div></a></li>
    		<li onclick="changeColor(this)"><a href="javascript:welderLess()"><div><img src="resources/images/c-2.png" />&nbsp;&nbsp;焊工最低排行</div></a></li>
    	</ul>
    </div>
	<!-- 公司 -->
    <div id="company1" >
